function imdb = imdb_from_customImageNet(flip)
...
cache_file = ['./imdb/cache/imdb_customImangeNet'];
if flip
...
%   VOCopts.testset = image_set;
  ...
  imdb.name = 'custom_ImageNet';
  imdb.image_dir = 'datasets/custom_dataset/images';
  imdb.image_ids = textread([imdb.image_dir, '/val.txt'], '%s');
  imdb.extension = 'JPEG';
  imdb.flip = flip;
  if flip
  ...
  imdb.classes = importdata('datasets/ImageNetData/class_labels');
