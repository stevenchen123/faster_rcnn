function imdb = imdb_from_ImageNet(flip)
...
cache_file = ['./imdb/cache/imdb_ImangeNet'];
if flip
...
%   VOCopts.testset = image_set;
  ...
  imdb.name = 'ImageNet_val';
  imdb.image_dir = 'datasets/ImageNetData/ILSVRC2013_DET_val';
